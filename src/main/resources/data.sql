...
INSERT IGNORE INTO `little_flower_shop`.`designs` (`title`, `description`, `create_at`) VALUES ('Bình hoa tươi', 'Hộp hoa nho nhỏ', NOW());
INSERT IGNORE INTO `little_flower_shop`.`designs` (`title`, `description`, `create_at`) VALUES ('Lãng hoa tươi', 'Hộp hoa nho nhỏ', NOW());
